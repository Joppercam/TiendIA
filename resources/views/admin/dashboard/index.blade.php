...
@section('content')
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-gray-900">${{ number_format($stats['monthly_sales']->sum('revenue'), 2) }}</p>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($stats['low_stock_products'] as $product)
                                <tr>
                                    ...
                                    // Continuación de la tabla en resources/views/admin/dashboard/index.blade.php
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('admin.products.edit', $product->id) }}" class="text-indigo-600 hover:text-indigo-900">Editar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.orders.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">Ver Todos</a>
        </div>
                        ...
                        @foreach($stats['recent_orders'] as $order)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.orders.show', $order->id) }}" class="text-indigo-600 hover:text-indigo-900">Ver</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const salesData = @json($stats['monthly_sales']);
